# -*- coding: utf-8 -*-
"""
Node Filter Shelf Button Script (Custom Path)
カスタムパスを指定してNode Filterを起動するためのスクリプト

使用方法:
1. SCRIPT_PATH変数に任意のパスを設定
2. このスクリプトをMayaのシェルフボタンに登録して実行
"""
import sys
import importlib

# ========================================
# カスタム設定: 任意のパスを指定してください
# ========================================
